document.addEventListener("DOMContentLoaded", () => {
  ...
  function displayFilteredActivities() {
    ...
    Object.entries(allActivities).forEach(([name, details]) => {
      ...
      if (currentDifficulty) {
        ...
        // If "All" is selected (empty string), only show activities without difficulty
  ...
  function handleShare(event) {
    ...
    // Create the share URL (current page URL with activity name as anchor)
    ...
    if (button.classList.contains('share-facebook')) {
      ...
      // Twitter/X share - using Twitter URL as it redirects to X automatically
